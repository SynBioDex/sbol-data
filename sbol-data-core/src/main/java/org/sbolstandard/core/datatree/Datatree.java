...
public final class Datatree
{
   ...
   * </p>
   * <ul>
   *   <li>{@link #DocumentRoot(org.sbolstandard.core.datatree.Datatree.NamespaceBindings, org.sbolstandard.core.datatree.Datatree.TopLevelDocuments)}</li>
   *   <li>{@link #DocumentRoot(org.sbolstandard.core.datatree.Datatree.TopLevelDocuments)}</li>
   * </ul>
   *
   * @author Matthew Pocock
   ...
   * </p>
   * <ul>
   *   <li>{@link #TopLevelDocument(org.sbolstandard.core.datatree.Datatree.NamespaceBindings, Object, java.net.URI, org.sbolstandard.core.datatree.Datatree.NamedProperties)}</li>
   *   <li>{@link #NestedDocument(org.sbolstandard.core.datatree.Datatree.NamespaceBindings, Object, java.net.URI, org.sbolstandard.core.datatree.Datatree.NamedProperties)}</li>
   * </ul>
   *
   * @author Matthew Pocock
   */
   ...
   *
   * <p>
   *   Used by {@link org.sbolstandard.core.datatree.TopLevelDocument} and {@link org.sbolstandard.core.datatree.NestedDocument}
   *   factory methods.
   * </p>
   *
   ...
   * <p>Used by</p>
   * <ul>
   *   <li>{@link #TopLevelDocument(Object, java.net.URI, org.sbolstandard.core.datatree.Datatree.NamedProperties)}</li>
   *   <li>{@link #TopLevelDocument(org.sbolstandard.core.datatree.Datatree.NamespaceBindings, Object, java.net.URI, org.sbolstandard.core.datatree.Datatree.NamedProperties)}</li>
   *   <li>{@link #NestedDocument(Object, java.net.URI, org.sbolstandard.core.datatree.Datatree.NamedProperties)}</li>
   *   <li>{@link #NestedDocument(org.sbolstandard.core.datatree.Datatree.NamespaceBindings, Object, java.net.URI, org.sbolstandard.core.datatree.Datatree.NamedProperties)}</li>
   * </ul>
   *
   * <p>
   ...
   *
   * <p>
   *   Used by {@link org.sbolstandard.core.datatree.NestedDocument}
   *   factory methods.
   * </p>
   *
